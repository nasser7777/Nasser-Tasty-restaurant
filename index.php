            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light"><a href="routers/logout.php">LOG OUT</i></a>
                        </li>
                    </ul>					
                </div>
            </nav>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
               <center> <h5 class="breadcrumbs-title">BREAK-FAST</h5></center>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div>
                  <table id="data-table-customer" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM items where foodtype = 'breakfast';");
