          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"><center>LUNCH</center></h5>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div>
                  <table id="data-table-customer" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM items where foodtype = 'lunch';");
...
<thead><tr>			<th>DRINK</th>
				...
				$result = mysqli_query($con, "SELECT * FROM items where foodtype = 'drink';");
				while($row = mysqli_fetch_array($result))
				{
					echo '<tr><td>'.$row["name"].'</td><td>'.$row["price"].'</td>';     
					echo '<td><div class="input-field col s12"><label for='.$row["id"].' class="">Quantity</label>';
